...
private:
    static bool ADC_Contains(const std::vector<AnalyzedDataContent>* adc, const FluxionValue* value);
    ...
    static FluxionValue* ReadBytesFromType_V1(std::istream& stream, unsigned char valueType, const Encoding* encoding);

    static FluxionValue* ReadBytesFromType_V2(std::istream& stream, unsigned char valueType, const Encoding* encoding,
                                              bool uniqueFlag);
